...
export const Footer = () => (
    <footer className="max-w-2xl h-96 mid:mt-32 mt-12">
        <h2 className="uppercase font-bold leading-tight mx-0 mid:mb-2 mb-0 mt-5 text-secondaryTextColor text-xs">Let's talk!</h2>
        <a className="font-black mid:text-4xl leading-10 text-headerTextColor no-underline m-0 text-2xl hover:text-blueElementColor"
            href={`mailto:${email}`}
            title={email}
            target="_blank"
        ...
        <p className="mid:text-xl leading-snug tracking-wider text-secondaryTextColor mid:mt-6 mid:mb-11 mx-0 mt-3 mb-9 text-sm ">
        ...
        <div>
            <a className="text-headerTextColor w-12 h-12 mr-6 mt-32 mb-5 ml-0 hover:text-blueElementColor"
                href={github}
                title={github}
                target="_blank"
                rel="noopener norefereer"
