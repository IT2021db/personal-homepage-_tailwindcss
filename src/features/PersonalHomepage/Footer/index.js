...
export const Footer = () => {
    ...
    return (
        <footer className="max-w-2xl h-96 mid:mt-32 mt-12">
            ...
            <p className={`mid:text-xl leading-snug tracking-wider ${isDark ? "text-white" : "text-secondaryTextColor"}  mid:mt-6 mid:mb-11 mx-0 mt-3 mb-9 text-sm`}>
            ...
            <div>
                <a className={`text- ${isDark ? "text-white" : "text-headerTextColor"} w-12 h-12 mr-6 mt-32 mb-5 ml-0 hover:text-blueElementColor`}
                    href={github}
                    title={github}
                    target="_blank"
                    rel="noopener norefereer"
                ...
                <a className={` w-12 h-12 mr-6 mt-32 mb-5 ml-0 ${isDark ? "text-white" : "text-headerTextColor"}  hover:text-blueElementColor`}
                    href={linkedIn}
                    title={linkedIn}
                    target="_blank"
                    rel="noopener norefereer"
